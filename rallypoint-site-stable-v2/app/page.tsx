...
const Stat = ({ value, label }: { value: string; label: string }) => (
  <div className="text-center">
    <div className="text-3xl md:text-4xl font-semibold text-[var(--brand-primary)]">{value}</div>
    <div className="text-slate-600 text-sm mt-1">{label}</div>
  </div>
);

const ListItem = ({ children }: { children: React.ReactNode }) => (
  <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 mt-0.5 text-[var(--brand-primary)]" /> <span className="text-slate-700">{children}</span></li>
);
    ...
    <div className="min-h-screen text-slate-900">
      ...
      <div className="w-full border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/50 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/logo-rp.svg" alt="Rally Point logo" className="h-10 w-10 rounded-full border border-[var(--brand-primary)]" />
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="tel:+1-555-555-5555" className="flex items-center gap-2 text-sm font-medium text-[var(--brand-primary)]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold leading-tight">
              ...
              <span className="block text-[var(--brand-primary)]">clear direction, steady support.</span>
            </h1>
          ...
          <div>
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-sm border border-[var(--brand-accent)]">
      ...
      <Section id="life-coaching" className="bg-[rgba(22,76,58,0.03)]">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6">
              <a href="#contact"><Button className="rounded-2xl">Inquire about coaching</Button></a>
            </div>
          </div>
          <div>
            <Card className="rounded-3xl border shadow-sm">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  {["Habit systems","Time blocking","Communication","Career clarity","Mindset shifts","Stress hygiene"].map((item) => <Pill key={item}>{item}</Pill>)}
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <div className="mt-6 space-y-3 text-sm text-slate-700">
              <div className="flex items-center gap-2"><Phone className="h-4 w-4 text-[var(--brand-primary)]" /> (555) 555-5555</div>
              <div className="flex items-center gap-2"><Mail className="h-4 w-4 text-[var(--brand-primary)]" /> hello@rallypointwellness.com</div>
              <div className="flex items-center gap-2"><MapPin className="h-4 w-4 text-[var(--brand-primary)]" /> Ventura, California (Telehealth statewide)</div>
            </div>
          </div>
      ...
      <footer className="border-t bg-white">
        <div className="max-w-6xl mx-auto px-4 py-10 grid md:grid-cols-4 gap-6 text-sm">
          <div className="col-span-2">
            <div className="flex items-center gap-3">
              <img src="/logo-rp.svg" alt="Rally Point logo" className="h-9 w-9 rounded-full border border-[var(--brand-primary)]" />
              <div className="font-semibold">{BRAND.name}</div>
            </div>
